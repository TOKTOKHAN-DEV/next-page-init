...
export const config: DefaultSeoProps = {
  ...
  titleTemplate: '똑똑한개발자 | %s', // 타이틀에 추가될 기본 title 템플릿입니다. 각 페이지에서 작성한 title이 %s에 적용됩니다.
  defaultTitle: '똑똑한개발자', // 페이지에 title이 설정되어 있지 않으면 빈 정보 대신 defaultTitle이 사용됩니다.
